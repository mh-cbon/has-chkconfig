if [ ! -f /home/vagrant/node/node-v5.9.1-linux-x64.tar.xz ]; then
  ...
  wget --no-check-certificate https://nodejs.org/dist/v5.9.1/node-v5.9.1-linux-x64.tar.xz
...
/home/vagrant/node/node-v5.9.1-linux-x64/bin/node /home/vagrant/node/node-v5.9.1-linux-x64/bin/mocha test/not-rhel.js
